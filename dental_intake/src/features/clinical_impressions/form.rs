                ...
                <shady_minions::ui::Card>
                    <div class="space-y-6">
                        <div class="text-center py-12">
                            ...
                            <p class="text-lg text-muted-foreground">{"Formulario de impresión clínica"}</p>
                            <p class="text-sm mt-2 text-muted">{"Próximamente: Resumen, hallazgos, diagnósticos, notas"}</p>
                        </div>
